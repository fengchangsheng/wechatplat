...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户管理 <span class="c-gray en">&gt;</span> 群组管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray">
		<span class="l">
			<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
			<a class="btn btn-primary radius" href="javascript:;" onclick="user_group_add('添加群组','toAdd','800')">
...
//				$('#resText').empty();   //清空resText里面的所有内容
				...
				$.each(groups, function(commentIndex, comment){
					html += '<tr class="text-c"><td><input type="checkbox" value="" name=""></td><td>'
					        ...
					        + '<a title="删除" href="javascript:;" onclick="user_group_del(this,\'1\')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>';
				});
				$('#gbody').append(html);
			}
		});
