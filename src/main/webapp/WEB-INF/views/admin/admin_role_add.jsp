		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<dl class="permission-list">
					<dt>
						<label>
							<input type="checkbox" value="${per.id}" name="ids" id="user-Character-0">
							${per.text}</label>
					</dt>
					<dd>
						...
						<dl class="cl permission-list2">
							<dt>
								<label class="">
									<input type="checkbox" value="${cper.id}" name="id_${i.index}_${j.index}" id="user-Character-0-${j.index}">
									${cper.text}</label>
							</dt>
							<dd>
								<label class="">
									<input type="checkbox" value="" name="" id="user-Character-0-0-0">
									增加</label>
								<label class="">
									<input type="checkbox" value="" name="" id="user-Character-0-0-1">
										修改</label>
								<label class="">
									<input type="checkbox" value="" name="" id="user-Character-0-0-2">
										删除</label>
								<label class="c-orange"><input type="checkbox" value="" name="" id="user-Character-0-0-5"> 只能操作自己发布的</label>
							</dd>
						</dl>
						</c:forEach>
					</dd>
